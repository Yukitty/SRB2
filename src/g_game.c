...
consvar_t cv_crosshair = {"crosshair", "Off", 0, crosshair_cons_t, NULL, 0, NULL, NULL, 0, 0, NULL};
consvar_t cv_crosshair2 = {"crosshair2", "Off", 0, crosshair_cons_t, NULL, 0, NULL, NULL, 0, 0, NULL};
#else
